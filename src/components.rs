use crate::config::{
    AerodynamicsConfig, PowertrainConfig, StabilityConfig, SteeringConfig, SuspensionConfig,
    TireGripConfig,
};
use avian3d::prelude::*;
use bevy::prelude::*;
...
/// Marker component — insert on a chassis entity to reset its powertrain
...
pub struct GroundVehicleWheel {
    ...
    pub auxiliary_brake_factor: f32,
...
pub(crate) struct GroundVehicleResolvedIntent {
    pub drive: f32,
    pub turn: f32,
    pub brake: f32,
    pub auxiliary_brake: f32,
