...
4. `ground_vehicle::components::GroundVehicleControl`
...
| Vehicle never moves under throttle | no driven wheels, zero drive force, or all wheels ungrounded | `drive_factor`, `grounded`, `longitudinal_force_newtons` |
...
| Drift state never enters | rear grip too high or handbrake multipliers too mild | drift ratio, rear wheel lateral force and speed |
...
BRP_PORT=15712 uv run --active --project .codex/skills/bevy-brp/script brp world query ground_vehicle::components::GroundVehicle ground_vehicle::components::GroundVehicleControl
...
- drift: handbrake-driven drift posture and telemetry
